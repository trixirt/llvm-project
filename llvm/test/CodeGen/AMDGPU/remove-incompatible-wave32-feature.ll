...
; WARN-GFX906: remark: needs_wavefrontsize32: removing function: +wavefrontsize32 is not supported on the current target
; WARN-GFX906-NOT: not supported

; WARN-GFX90A: remark: needs_wavefrontsize32: removing function: +wavefrontsize32 is not supported on the current target
